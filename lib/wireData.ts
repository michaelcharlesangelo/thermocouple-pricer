...
//
// D  = grams of Pt/Rh alloy per meter of wire ("g / doublemeter")
// F  = manufacturing price (EUR/g) for orders < 25 meters of that spec
// G  = manufacturing price (EUR/g) for orders 25 - 49.9 meters
// H  = manufacturing price (EUR/g) for orders >= 50 meters
//
